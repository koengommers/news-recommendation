...
class HieRecUserEncoder(nn.Module):
    ...
    def forward(self, news, mask: Optional[torch.Tensor] = None):
        ...
        news_attention_weights = masked_softmax(
            news_attention_scores, subcategory_mask, dim=1
        )
        ...
        subcategory_attention_weights = masked_softmax(
            subcategory_attention_scores, subcategory_to_category, dim=1
        )
